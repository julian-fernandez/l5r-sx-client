  ...
  const handleGameReady = useCallback((payload: GameReadyPayload) => {
    ...
    const opponentState: PlayerState = {
      ...
      hand: Array.from({ length: opponentInfo.handCount }, (_, i) => ({
        ...
        cardId: 'unknown',
        card: (ownState.fateDeck[0]?.card ?? ownState.hand[0]?.card ?? null) as unknown as import('./types/cards').NormalizedCard,
        bowed: false,
        faceUp: false,
      ...
      fateDeck: Array.from({ length: opponentInfo.fateDeckCount }, (_, i) => ({
        ...
        cardId: 'unknown',
        card: null as unknown as import('./types/cards').NormalizedCard,
        bowed: false,
        faceUp: false,
